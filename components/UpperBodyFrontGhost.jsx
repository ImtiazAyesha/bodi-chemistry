    ...
    <div style={{
      ...
      <svg
        style={{
          ...
          height: window.innerWidth < 640 ? 'min(105vw, max(calc(140vh - 180px), 560px))' : 'min(75vw, max(calc(100vh - 180px), 400px))',
      ...
      >
        <g transform="translate(240, 480)">
          ...
          {/* Silhouette Path - increased scale to fill more viewport */}
          <g transform="scale(4.5) translate(-103, -103)">
            <path
