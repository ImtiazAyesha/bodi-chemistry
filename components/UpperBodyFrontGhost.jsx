...
const UpperBodyFrontGhost = ({ isAligned, holdDuration = 0, stage2Debug = null }) => {
  ...
  const primaryColor = isAligned ? '#00FF00' : 'rgba(255, 255, 255, 0.5)';
  const fillColor = isAligned ? 'rgba(0, 255, 0, 0.15)' : 'rgba(47, 74, 92, 0.05)';
  ...
  return (
    <div style={{
      ...
      >
        {/* ✨ FIXED: Adjusted silhouette position (y=420) for better centering */}
        <g transform="translate(240, 400)">
          {/* Glow effect when aligned */}
          {isAligned && (
            <ellipse cx="0" cy="50" rx="300" ry="400"
      ...
      <div style={{
        ...
        <div style={{
          ...
          {isAligned ? '✓ Hold Position' : (feedbackMessage || 'Face the camera')}
